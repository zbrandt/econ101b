...
\begin{homeworkProblem}
    ...
    An increase in government purchases makes Robinson Crusoe worse off. This is because the government
    purchases multiplier is less than one, meaning that an increase in government purchases will result in
    a less than one-for-one increase in output. An increase in government purchases reduces
    Robinson Crusoe's consumption and therefore utility. If Robinson Crusoe does not value the things the 
    government purchases, then the decrease in consumption will be even more pronounced, because the utility 
    from government purchases will be nil. 
