\begin{homeworkProblem}[2]
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=1\linewidth]{pset4/crazy.png}
        % \caption{Caption}
    ...
    If the changes in the monetary supply and inflation were as predictable
    as seen in the plot, producers will probably not suddenly continuously
    be shocked such that their output gap jumps up and down forever. Instead,
    they will adjust their expectations accordingly to minimize sudden deviations
    from their preferred output.
